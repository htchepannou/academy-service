...
INSERT INTO T_SEGMENT(id, course_fk, lesson_fk, type_fk, video_fk, rank, title) VALUES(3029, 300, 302, 1, 3021, 1, 'Using SELECT');
INSERT INTO T_SEGMENT(id, course_fk, lesson_fk, type_fk, rank, title) VALUES(3022, 300, 302, 2, 2, 'Quiz #2');

INSERT INTO T_SEGMENT(id, course_fk, lesson_fk, type_fk, video_fk, rank, title) VALUES(3031, 300, 303, 1, 3031, 1, 'Project');
