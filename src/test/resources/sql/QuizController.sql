...
INSERT INTO T_QUIZ(id, type_fk, video_fk, question, description, success_message, failure_message) VALUES(10103, 2, 101031, 'Who might be a potential end user of documentation?', 'This is the description', 'Awesome', 'Looser');
